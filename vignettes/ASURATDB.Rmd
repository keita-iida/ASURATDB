...
res <- do.call("rbind", list(human_CO[["cell"]], human_MSig[["cell"]],
                             human_CellMarker[["cell"]]))
res$IC <- NA
human_COMSigCellMarker <- list(cell = res)
```
...
load(url(paste0(urlpath, "20220304_human_CellMarker.rda?raw=true")))
res <- do.call("rbind", list(human_DO[["disease"]], human_CO[["cell"]],
                             human_MSig[["cell"]], human_CellMarker[["cell"]]))
res$IC <- NA
human_DOCOMSigCellMarker <- list(cell = res)
```
